---
title: "Signal and batch Correction, data assessment and correction"
author: 
...
vignette: >
    %\VignetteIndexEntry{Details signal/batch correction and data assessment}
...
method to normalise data, KNN for missing value imputation and finally glog
scaling method using other functions from `pmp` package. 
A more detailed description on data filtering is detailed in @guida2016.
...
## Example of signal and batch correction for a single feature {#algorithm}
